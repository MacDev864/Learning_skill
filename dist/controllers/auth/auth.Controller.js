...
var register = exports.register = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(req, res) {
    var _register, status;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _context.prev = 0;
          req.body.password = _repo["default"].genPassword("1234567890", 6);
          _context.next = 4;
          return (0, _auth.registers)(req.body);
        case 4:
          _register = _context.sent;
          status = _register.success ? 200 : 404;
          return _context.abrupt("return", res.status(status).send(_register));
        case 9:
          _context.prev = 9;
    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        ...
        case 3:
          ...
          return _context2.abrupt("return", res.status(status).send(_login));
        case 8:
          _context2.prev = 8;
