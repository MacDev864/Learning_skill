      ...
      while (1) switch (_context.prev = _context.next) {
        ...
        case 3:
          ...
          return _context.abrupt("return", {
            data: isTitleExit,
            message: "Title address ".concat(title, " is already exists, please pick a different one."),
            success: false,
            error: true
          });
        case 6:
          newnote = new _note.NoteModel(notedata);
          newnote.save();
          return _context.abrupt("return", {
            data: newnote,
    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          ...
          _context2.next = 9;
          return _note.NoteModel.find(baseQuery).skip((page - 1) * size).limit(size).exec();
        case 9:
