...
var registers = exports.registers = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(userdata) {
    var username, password, isNameExit, message, data_set, sendMessage, rs, user;
      ...
      while (1) switch (_context.prev = _context.next) {
        ...
        case 3:
          ...
          return _context.abrupt("return", {
            data: isNameExit,
            message: "Username address ".concat(username, " is already exists, please pick a different one."),
            success: false,
            error: true
          });
        case 6:
          /*------------message---------------- */
          message = "รหัสผ่านของคุณคือ : ";
          _context.next = 9;
        ...
        case 9:
          ...
          _context.next = 14;
          return _Sms["default"].sendMessage(data_set);
        case 14:
        ...
        case 18:
          /* ---------------------------- */
          user = new _users["default"](userdata);
          user.save();
          /* ---------------------------- */
          return _context.abrupt("return", {
            data: user,
      ...
      while (1) switch (_context2.prev = _context2.next) {
        ...
        case 4:
          ...
          return _context2.abrupt("return", {
            data: user,
            message: "Username address ".concat(username, " is not founds."),
            success: false,
            error: true
          });
        case 7:
